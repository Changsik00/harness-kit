...
| ID | 슬러그 | 우선순위 | 상태 | 디렉토리 |
|---|---|:---:|---|---|
| spec-3-001 | zsh-native-scripts | P0 | Backlog | `specs/spec-3-001-zsh-native-scripts/` |
| spec-3-002 | macos-install-guide | P1 | Backlog | `specs/spec-3-002-macos-install-guide/` |
| spec-3-003 | linux-ci-validation | P1 | Backlog | `specs/spec-3-003-linux-ci-validation/` |
<!-- sdd:specs:end -->
...
### 통합 테스트 실행
```bash
./tests/test-phase-3.sh
```

## 🔗 의존성

- **선행 phase**: phase-2 (거버넌스 경량화 후 스크립트 변경이 줄어듦)
