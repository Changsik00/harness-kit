# phase-2: 토큰 최적화 & 거버넌스 경량화

> 본 phase 의 모든 SPEC 을 한 파일에 요점/방향성으로 나열합니다.
> *구체적* 작업 내용은 `specs/spec-2-{seq}-{slug}/spec.md` 에서 다룹니다.
...
| ID | 슬러그 | 우선순위 | 상태 | 디렉토리 |
|---|---|:---:|---|---|
| spec-2-001 | governance-dedup | P0 | Backlog | `specs/spec-2-001-governance-dedup/` |
| spec-2-002 | two-tier-loading | P0 | Backlog | `specs/spec-2-002-two-tier-loading/` |
| spec-2-003 | enforce-to-suggest | P1 | Backlog | `specs/spec-2-003-enforce-to-suggest/` |
<!-- sdd:specs:end -->

### spec-2-001 — 거버넌스 문서 중복 제거
