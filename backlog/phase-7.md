...
| ID | 슬러그 | 우선순위 | 상태 | 디렉토리 |
|---|---|:---:|---|---|
| spec-7-001 | scope-classification-rules | P1 | Backlog | `specs/spec-7-001-scope-classification-rules/` |
| spec-7-002 | spec-critique-workflow | P1 | Backlog | `specs/spec-7-002-spec-critique-workflow/` |
| spec-7-003 | plan-accept-consistency | P2 | Backlog | `specs/spec-7-003-plan-accept-consistency/` |
| spec-7-004 | pr-confirm-ux | P2 | Backlog | `specs/spec-7-004-pr-confirm-ux/` |
<!-- sdd:specs:end -->
...
### spec-7-002 — Spec/Plan 자기비판 워크플로우
