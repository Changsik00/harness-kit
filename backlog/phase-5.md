# phase-5: spec-kit 패턴 도입 & 크로스 에이전트 호환

> 본 phase 의 모든 SPEC 을 한 파일에 요점/방향성으로 나열합니다.
> *구체적* 작업 내용은 `specs/spec-5-{seq}-{slug}/spec.md` 에서 다룹니다.
...
| ID | 슬러그 | 우선순위 | 상태 | 디렉토리 |
|---|---|:---:|---|---|
| spec-5-001 | spec-kit-benchmark | P2 | Backlog | `specs/spec-5-001-spec-kit-benchmark/` |
| spec-5-002 | agents-md-compat | P2 | Backlog | `specs/spec-5-002-agents-md-compat/` |
<!-- sdd:specs:end -->

### spec-5-001 — spec-kit 워크플로 벤치마크 (Research Spec)
...
### 통합 테스트 실행
```bash
./tests/test-phase-5.sh
```

## 🔗 의존성

- **선행 phase**: phase-2, phase-3 (기반 안정화 후)
