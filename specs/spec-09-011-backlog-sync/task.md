...
- [x] `git checkout -b spec-09-011-backlog-sync` (from `phase-09-install-conflict-defense`)
- [x] Commit: 없음 (브랜치 생성만)
...
- [x] 테스트 실행 → PASS 확인
- [x] Commit: `fix(spec-09-011): reinforce cmd_archive post-processing`
...
- [x] 테스트 실행 → PASS 확인
- [x] Commit: `chore(spec-09-011): remove dead NOW/NEXT markers from queue template`
...
- [x] Commit: `docs(spec-09-011): add post-merge protocol to agent.md`
...
- [x] 통합 테스트 실행 → PASS 확인
- [x] Commit: `chore(spec-09-011): sync dogfooding sdd binary`
...
- [ ] **Archive Commit**: `docs(spec-09-011): archive walkthrough and pr description`
- [ ] **Push**: `git push -u origin spec-09-011-backlog-sync`
- [ ] **PR 생성**
