...
- [x] `cmd_status()` Branch 라인에 work mode 표시: `Branch: spec-10-002-... (SDD-P (phase-10))`
...
Check 1: 브랜치 패턴 → work mode 추론
  ✅ PASS: spec-10-001-test-slug → SDD-P
...
1. **Action**: `sdd status` 실행 (spec-10-002 브랜치에서)
   - **Result**: `Branch: spec-10-002-status-cross-check (SDD-P (phase-10))` 정상 표시
