...
Commit: `7184a7a test(spec-9-005): add failing test for update.sh rewrite`
...
Commit: `4033ffc refactor(spec-9-005): rewrite update.sh as uninstall+install+cleanup`
