...
### 1-1. 브랜치 생성
- [ ] `git checkout -b spec-9-008-ship-idea-capture` (from `phase-9-install-conflict-defense`)
...
- [ ] Commit: `feat(spec-9-008): add idea capture gate and opinion divergence protocol to constitution`
...
- [ ] Commit: `feat(spec-9-008): extend bootstrap protocol with continuity check`
...
- [ ] Commit: `chore(spec-9-008): sync dogfooding copies`
...
- [ ] **Archive Commit**: `docs(spec-9-008): archive walkthrough and pr description`
- [ ] **Push**: `git push -u origin spec-9-008-ship-idea-capture`
- [ ] **PR 생성**: 사용자 승인 후
