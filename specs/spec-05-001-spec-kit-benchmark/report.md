# Research Report: spec-05-001 — spec-kit 워크플로 벤치마크
...
spec-kit은 여러 AI 에이전트를 지원하지만, harness-kit은 Claude Code 전용으로 깊이를 추구한다. 이 방향은 spec-05-002 (AGENTS.md 호환)에서 별도 검토.
...
### Go
1. **병렬 태스크 표시**: task.md에 병렬 가능 마커 도입 검토 (phase-06에 추가 가능)
