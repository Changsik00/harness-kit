...
| **Spec ID** | `spec-08-001` |
| **Phase** | `phase-08` |
| **Branch** | `spec-08-001-queue-redesign` |
| **Base** | `phase-08-work-model` (just-in-time 생성 — 첫 hk-ship 시 자동) |
| **상태** | Plan Accepted |
| **타입** | Refactor |
...
- Phase base branch 생성/관리 로직 (→ spec-08-002)
- hk-ship archive 강제 (→ spec-08-003)
- hk-align 출력 개선 (→ spec-08-004)

## ✅ Definition of Done

- [ ] 모든 단위 테스트 PASS
- [ ] `walkthrough.md` 와 `pr_description.md` 작성 및 archive commit
- [ ] `spec-08-001-queue-redesign` 브랜치 push 완료 (→ phase-08 브랜치 타깃)
- [ ] 사용자 검토 요청 알림 완료
