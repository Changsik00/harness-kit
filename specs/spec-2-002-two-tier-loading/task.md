...
### 1-1. 브랜치 생성
- [x] `git checkout -b spec-2-002-two-tier-loading`
- [x] Commit: 없음 (브랜치 생성만)
...
- [x] Commit: `refactor(spec-2-002): remove @imports from CLAUDE.md.fragment`
...
- [x] Commit: `chore(spec-2-002): sync CLAUDE.md harness block with fragment`
...
- [x] 테스트 실행 → 7/7 PASS
- [x] Commit: `test(spec-2-002): add two-tier loading verification test`
