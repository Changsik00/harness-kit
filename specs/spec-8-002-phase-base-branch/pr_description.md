# feat(spec-8-002): add phase base branch support (opt-in --base flag)
...
### Phase 컨텍스트
- **Phase**: `phase-8`
- **본 SPEC 의 역할**: phase-8의 도그푸딩 첫 사례 — `phase-8-work-model` 브랜치에 spec-8-001 ~ spec-8-004 가 쌓이는 구조를 가능하게 함
...
- Spec: `specs/spec-8-002-phase-base-branch/spec.md`
- Walkthrough: `specs/spec-8-002-phase-base-branch/walkthrough.md`
