# feat(spec-08-002): add phase base branch support (opt-in --base flag)
...
### Phase 컨텍스트
- **Phase**: `phase-08`
- **본 SPEC 의 역할**: phase-08의 도그푸딩 첫 사례 — `phase-08-work-model` 브랜치에 spec-08-001 ~ spec-08-004 가 쌓이는 구조를 가능하게 함
...
- Spec: `specs/spec-08-002-phase-base-branch/spec.md`
- Walkthrough: `specs/spec-08-002-phase-base-branch/walkthrough.md`
