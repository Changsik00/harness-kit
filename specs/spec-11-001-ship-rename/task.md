...
### 1-1. 브랜치 생성
- [x] `git checkout -b spec-11-001-ship-rename`
- [x] Commit: 없음 (브랜치 생성만)
...
- [x] Commit: `refactor(spec-11-001): rename sdd archive to sdd ship`
...
- [x] Commit: `docs(spec-11-001): update governance, templates, and commands for ship rename`
...
- [x] Commit: `test(spec-11-001): rename and update tests for sdd ship`
...
- [ ] **Ship Commit**: `docs(spec-11-001): ship walkthrough and pr description`
- [ ] **Push**: `git push -u origin spec-11-001-ship-rename`
- [ ] **PR 생성**: `/hk-pr-gh`
