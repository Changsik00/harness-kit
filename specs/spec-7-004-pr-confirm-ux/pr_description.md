# refactor(spec-7-004): standardize pr/push confirm ux across all commands
...
- **본 SPEC의 역할**: 에이전트 반복 행동(PR/Push 확인) 표준화 — 마지막 phase-7 spec
...
- Walkthrough: `specs/spec-7-004-pr-confirm-ux/walkthrough.md`
