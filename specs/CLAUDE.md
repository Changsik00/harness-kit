...
- **한국어 산출물**: spec.md / task.md / walkthrough.md / pr_description.md / critique.md 모두 한국어로 작성. 코드·파일 경로·표준 기술 용어만 영어 허용.
...
| 파일 | 역할 |
|---|---|
| `spec.md` | 배경 / 요구사항 / 범위 / 핵심 전략 / 변경 목록 / 검증 / 롤백 / DoD (구 `plan.md` 통합) |
