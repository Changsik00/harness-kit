# feat(spec-9-009): preflight UX — 설치/업데이트 전 사전 스캔
...
- Critique: `specs/spec-9-009-preflight-ux/critique.md`
- Walkthrough: `specs/spec-9-009-preflight-ux/walkthrough.md`
