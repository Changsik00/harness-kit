...
- [ ] `git checkout -b spec-9-013-auto-ship` (from `phase-9-install-conflict-defense`)
- [ ] Commit: 없음 (브랜치 생성만)
...
- [ ] Commit: `feat(spec-9-013): auto-ship delegation in governance docs`
...
- [ ] Commit: `feat(spec-9-013): auto-ship in hk-ship command`
...
- [ ] **Archive Commit**: `docs(spec-9-013): archive walkthrough and pr description`
- [ ] **Push**: `git push -u origin spec-9-013-auto-ship`
- [ ] **PR 생성**
