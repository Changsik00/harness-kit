# Implementation Plan: spec-9-001

## 📋 Branch Strategy

- 신규 브랜치: `spec-9-001-dir-layout`
- 시작 지점: `main`
- PR 타깃: `phase-9-install-conflict-defense` (첫 hk-ship 시 자동 생성)
...
1. `bash .harness-kit/bin/sdd status` 실행 — 기대 결과: phase-9 active 정상 출력
