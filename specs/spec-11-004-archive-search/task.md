...
### 1-1. 브랜치 생성
- [x] `git checkout -b spec-11-004-archive-search`
...
- [x] Commit: `feat(spec-11-004): add archive fallback to spec/phase search commands`
...
- [x] Commit: `test(spec-11-004): add archive search integration tests`
...
- [ ] **Ship Commit**: `docs(spec-11-004): ship walkthrough and pr description`
- [ ] **Push**: `git push -u origin spec-11-004-archive-search`
- [ ] **PR 생성**: `/hk-pr-gh`
