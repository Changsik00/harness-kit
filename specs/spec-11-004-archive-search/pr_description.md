# feat(spec-11-004): 아카이브 검색 통합

## 📋 Summary

### 배경 및 목적
spec-11-003에서 `sdd archive`로 디렉토리 아카이브가 가능해졌지만, 아카이브 후 `sdd spec list`, `sdd phase list` 등에서 항목이 사라지는 문제.
...
- Walkthrough: `specs/spec-11-004-archive-search/walkthrough.md`
