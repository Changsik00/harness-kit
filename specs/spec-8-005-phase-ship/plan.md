# Implementation Plan: spec-8-005

## 📋 Branch Strategy

- 신규 브랜치: `spec-8-005-phase-ship`
- 시작 지점: `phase-8-work-model` (spec-8-004 merge 완료 기준)
...
> - [ ] `/hk-phase-ship` 완성 후 바로 phase-8 자체에 적용하여 도그푸딩 검증
...
본 spec 완료 후, `/hk-phase-ship` 을 **phase-8 자체에 적용**하여 검증합니다:
1. phase-8.md 성공 기준 6개 검증
2. 통합 테스트 시나리오 4종 실행
3. 사용자 go/no-go 협의
4. Phase PR 생성
