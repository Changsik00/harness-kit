...
- [x] Commit: `feat(spec-8-005): add hk-phase-ship slash command`
...
- [x] Commit: `feat(spec-8-005): add phase-ship pr template`
...
- [x] Commit: `docs(spec-8-005): add phase ship governance rules to constitution and agent`
...
- [x] **Archive Commit**: `docs(spec-8-005): archive walkthrough and pr description`
- [x] **Push**: `git push -u origin spec-8-005-phase-ship`
- [x] **PR 생성**: 타깃 `phase-8-work-model`
...
| **총 Task 수** | 3 |
| **예상 commit 수** | 4 |
| **현재 단계** | Done (phase-8 PR #27로 main 머지 완료) |
| **마지막 업데이트** | 2026-04-12 |
