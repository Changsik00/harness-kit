# feat(spec-09-002): switch CLAUDE.md install to 3-line @import
...
- **본 SPEC 의 역할**: CLAUDE.md merge conflict 위험 제거. spec-09-001(디렉토리 레이아웃)에 이어 두 번째 충돌 방어 레이어.
...
- `specs/spec-09-002-claude-md-import/`: spec, plan, task, walkthrough, pr_description
...
- Walkthrough: `specs/spec-09-002-claude-md-import/walkthrough.md`
