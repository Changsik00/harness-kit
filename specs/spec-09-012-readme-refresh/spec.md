...
| **Spec ID** | `spec-09-012` |
| **Phase** | `phase-09` |
| **Branch** | `spec-09-012-readme-refresh` |
| **상태** | Planning |
| **타입** | Docs |
...
README.md가 v0.3.0 기준으로 작성되어 있으나, phase-09에서 디렉토리 레이아웃이 `.harness-kit/`으로 전면 변경되었다.
...
5. **NOW/NEXT 언급**: queue.md에서 제거됨 (spec-09-011)
...
- [ ] `spec-09-012-readme-refresh` 브랜치 push 완료
