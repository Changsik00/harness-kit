# docs(spec-8-004): strengthen hk-align, add governance rules, and update README

## 📋 Summary

### 배경 및 목적

phase-8의 마지막 spec. hk-align에 NOW/NEXT 표시를 추가하고, agent.md에 작업 유형별 행동 규칙과 완료 체크리스트를 명문화한다. README를 phase-8 변경사항(작업 유형 모델, phase base branch, archive completion gate 등)으로 최신화한다.
...
### Phase 컨텍스트
- **Phase**: `phase-8` (마지막 spec)
- **본 SPEC 의 역할**: phase-8 전체 변경사항을 거버넌스와 사용자 문서에 통합하여 마무리
...
3. **README 작업 유형 모델 섹션**: Phase base branch, NOW/NEXT/Icebox 등 phase-8의 핵심 개념을 사용자에게 설명.
...
- Spec: `specs/spec-8-004-align-and-governance/spec.md`
