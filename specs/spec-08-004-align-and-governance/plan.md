# Implementation Plan: spec-08-004

## 📋 Branch Strategy

- 신규 브랜치: `spec-08-004-align-and-governance`
- 시작 지점: `phase-08-work-model` (spec-08-003 merge 완료 기준)
...
| **README** | 전면 최신화 | phase-08 변경사항 + 오래된 커맨드명 정리 |
