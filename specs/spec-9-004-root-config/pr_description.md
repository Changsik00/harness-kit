...
- `test(spec-9-004): update test-path-config for rootDir`
- `feat(spec-9-004): always write rootDir to harness.config.json`
- `refactor(spec-9-004): sdd_find_root reads rootDir from config`
