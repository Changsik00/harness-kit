...
$ bash tests/test-path-config.sh
 Path Config System Verification (spec-09-003)
...
Commit: `18687c6 test(spec-09-003): add failing test for path config system`
...
Commit: `2b6390b refactor(spec-09-003): fix common.sh agent paths and add config reading`
...
Commit: `e1aae6e feat(spec-09-003): add prefix UX and harness.config.json to install.sh`
...
Commit: `b8aa140 refactor(spec-09-003): doctor.sh reflects harness.config.json paths`
