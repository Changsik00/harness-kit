# refactor(spec-7-003): standardize plan accept prompt and allowed responses
...
2. **프롬프트 순서 변경**: spec-7-002에서 Critique를 1번으로 정의했으나, 기본 경로(Plan Accept)를 1번으로 변경 — 사용자 피드백 반영
...
- Walkthrough: `specs/spec-7-003-plan-accept-consistency/walkthrough.md`
- 참고: spec-7-002 (`sources/governance/agent.md §4.4` 원본 정의)
