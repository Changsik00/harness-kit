...
- [ ] `git checkout -b spec-9-012-readme-refresh` (from `phase-9-install-conflict-defense`)
- [ ] Commit: 없음 (브랜치 생성만)
...
- [ ] Commit: `docs(spec-9-012): update README.md for v0.4.0 layout`
...
- [ ] **Archive Commit**: `docs(spec-9-012): archive walkthrough and pr description`
- [ ] **Push**: `git push -u origin spec-9-012-readme-refresh`
- [ ] **PR 생성**
