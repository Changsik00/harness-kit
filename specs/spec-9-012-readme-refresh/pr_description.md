# docs(spec-9-012): README v0.5.0 최신화

## 📋 Summary

### 배경 및 목적

README.md가 v0.3.0 기준으로 작성되어 있어, phase-9에서 변경된 `.harness-kit/` 디렉토리 레이아웃, `@import` 방식 CLAUDE.md, NOW/NEXT 제거 등이 반영되지 않았다.
...
- **Phase**: `phase-9`
- **본 SPEC의 역할**: phase-9 마지막 spec — 모든 변경사항을 README에 반영하여 문서 정합성 확보
