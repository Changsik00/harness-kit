...
### 1-1. 브랜치 생성
- [x] `git checkout -b spec-9-006-gitignore-config`

### 1-2. 테스트 작성 (TDD Red)
- [x] `tests/test-gitignore-config.sh` 작성 (11 checks)
- [x] 테스트 실행 → FAIL 확인
- [x] Commit: `test(spec-9-006): add failing tests for gitignore config option`
...
- [x] Commit: `feat(spec-9-006): add gitignore config option to install.sh and update.sh`
