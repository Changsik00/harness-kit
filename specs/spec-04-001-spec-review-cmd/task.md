...
- [x] plan.md 작성
- [x] task.md 작성 (이 파일)
- [x] 백로그 업데이트 (phase-04.md SPEC 표 갱신)
- [x] 사용자 Plan Accept
...
### 1-1. 브랜치 생성
- [x] `git checkout -b spec-04-001-spec-review-cmd`
- [x] Commit: 없음 (브랜치 생성만)
...
- [x] 한국어 출력 지시
- [x] `review.md` 저장 지시
- [x] Commit: `feat(spec-04-001): add /spec-review slash command`

### 1-3. 도그푸딩 반영
- [x] `.claude/commands/spec-review.md`로 복사
- [x] Commit: `chore(spec-04-001): copy spec-review command for dogfooding`
...
- [x] **Archive Commit**: `docs(spec-04-001): archive walkthrough and pr description`
- [x] **Push**: `git push -u origin spec-04-001-spec-review-cmd`
