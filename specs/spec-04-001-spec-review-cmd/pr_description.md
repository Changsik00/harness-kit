# feat(spec-04-001): /spec-review 슬래시 커맨드 추가
...
- **본 SPEC 의 역할**: phase-04의 첫 번째 spec으로, spec/plan 리뷰 기능을 제공하여 독립 검증 체계의 기반을 마련
...
- Walkthrough: `specs/spec-04-001-spec-review-cmd/walkthrough.md`
