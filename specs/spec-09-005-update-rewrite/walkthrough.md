...
▶ 시나리오 A: 기본 update (state 보존)
  ...
  ✅ state 보존: phase=phase-09 spec=spec-09-005-update-rewrite
...
Commit: `7184a7a test(spec-09-005): add failing test for update.sh rewrite`
...
Commit: `4033ffc refactor(spec-09-005): rewrite update.sh as uninstall+install+cleanup`
