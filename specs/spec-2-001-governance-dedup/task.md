...
### 1-1. 브랜치 생성
- [x] `git checkout -b spec-2-001-governance-dedup`
- [x] Commit: 없음 (브랜치 생성만)
...
- [x] Commit: `fix(spec-2-001): update pr creation rule to reflect slash commands`
...
- [x] Commit: `refactor(spec-2-001): deduplicate and clean up agent.md`
...
- [x] Commit: `chore(spec-2-001): sync agent/ with sources/governance/`
...
- [x] Commit: `test(spec-2-001): add governance dedup verification test`
