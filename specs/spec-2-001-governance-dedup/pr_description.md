# refactor(spec-2-001): 거버넌스 문서 중복 제거 및 실효성 정리
...
- **본 SPEC 의 역할**: 거버넌스 문서의 단일 진실 원천(SSOT) 확보 및 ~274 words 절감. phase-2의 토큰 최적화 목표 중 첫 단계.
...
- Walkthrough: `specs/spec-2-001-governance-dedup/walkthrough.md`
