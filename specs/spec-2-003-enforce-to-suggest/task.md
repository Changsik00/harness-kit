...
### 1-1. 브랜치 생성
- [x] `git checkout -b spec-2-003-enforce-to-suggest`
...
- [x] Commit: `feat(spec-2-003): add per-hook mode resolution to _lib.sh`
...
- [x] Commit: `feat(spec-2-003): apply per-hook default modes to all hooks`
...
- [x] Commit: `feat(spec-2-003): add sdd hooks subcommand`
...
- [x] diff 검증
- [x] Commit: `chore(spec-2-003): sync scripts/harness/ with sources/`
...
- [x] **Push**: `git push -u origin spec-2-003-enforce-to-suggest`
- [x] **PR 생성**: `/gh-pr`
