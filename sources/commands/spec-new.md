...
> "active phase 가 없습니다. 먼저 `bin/sdd phase new <slug>` 로 phase 를 만들어 주세요."

그리고 멈춥니다.

## 2. SPEC 생성

active phase 가 있다면 다음 명령으로 SPEC 디렉토리와 템플릿 5종 (spec.md / plan.md / task.md / walkthrough.md / pr_description.md) 을 생성합니다:
