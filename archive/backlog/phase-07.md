...
| ID | 슬러그 | 우선순위 | 상태 | 디렉토리 |
|---|---|:---:|---|---|
| spec-07-01 | scope-classification-rules | P1 | Backlog | `specs/spec-07-01-scope-classification-rules/` |
| spec-07-02 | spec-critique-workflow | P1 | Backlog | `specs/spec-07-02-spec-critique-workflow/` |
| spec-07-03 | plan-accept-consistency | P2 | Backlog | `specs/spec-07-03-plan-accept-consistency/` |
| spec-07-04 | pr-confirm-ux | P2 | Backlog | `specs/spec-07-04-pr-confirm-ux/` |
<!-- sdd:specs:end -->

### spec-07-01 — SDD-Phase/SDD-x/FF 분류 기준 강화
...
### spec-07-02 — Spec/Plan 자기비판 워크플로우
...
| 위험 | 영향 | 완화책 |
|---|---|---|
| spec-07-04 서브에이전트 비용 증가 | 매 spec마다 Opus 2회 호출 | 선택적(optional) 단계로 설계, 기본 off |
