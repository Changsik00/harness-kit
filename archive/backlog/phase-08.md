...
| ID | 슬러그 | 우선순위 | 상태 | 디렉토리 |
|---|---|:---:|---|---|
| spec-08-01 | queue-redesign | P1 | Merged | `specs/spec-08-01-queue-redesign/` |
| spec-08-02 | phase-base-branch | P1 | Merged | `specs/spec-08-02-phase-base-branch/` |
| spec-08-03 | ship-completion-gate | P1 | Merged | `specs/spec-08-03-ship-completion-gate/` |
| spec-08-04 | align-and-governance | P2 | Merged | `specs/spec-08-04-align-and-governance/` |
| spec-08-05 | phase-ship | P1 | Merged | `specs/spec-08-05-phase-ship/` |
<!-- sdd:specs:end -->

### spec-08-01 — 작업 분류 모델 정의 & Queue 재설계
...
### spec-08-02 — Phase base branch 지원 (opt-in)
...
### spec-08-03 — 완료 흐름 강제 (hk-ship 재설계)
...
### spec-08-04 — hk-align 강화 & 거버넌스 통합
...
- **Given**: phase-08 진행 중, spec-08-01 완료(Merged), spec-08-02 In Progress
- **When**: `sdd status` 실행
- **Then**: `NOW: spec-08-02`, `NEXT: spec-08-03` 출력
- **연관 SPEC**: spec-08-01

### 시나리오 2: Phase base branch just-in-time 생성
- **Given**: phase-08가 base branch 모드, spec-08-02 작업 완료, phase-08 브랜치 미존재
- **When**: hk-ship 실행
- **Then**: phase-08 브랜치 자동 생성 → spec-08-02 PR이 phase-08 타깃으로 생성됨
- **연관 SPEC**: spec-08-02
...
- **외부 시스템**: 없음
- **spec 내부 의존성**: spec-08-01 → spec-08-02, 003 / spec-08-01, 002, 003 → spec-08-04
