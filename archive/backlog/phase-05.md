...
| ID | 슬러그 | 우선순위 | 상태 | 디렉토리 |
|---|---|:---:|---|---|
| spec-05-01 | spec-kit-benchmark | P2 | Backlog | `specs/spec-05-01-spec-kit-benchmark/` |
| spec-05-02 | agents-md-compat | P2 | Backlog | `specs/spec-05-02-agents-md-compat/` |
<!-- sdd:specs:end -->

### spec-05-01 — spec-kit 워크플로 벤치마크 (Research Spec)
