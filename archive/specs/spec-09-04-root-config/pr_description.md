...
- `test(spec-09-04): update test-path-config for rootDir`
- `feat(spec-09-04): always write rootDir to harness.config.json`
- `refactor(spec-09-04): sdd_find_root reads rootDir from config`
