...
- [ ] `git checkout -b spec-09-12-readme-refresh` (from `phase-09-install-conflict-defense`)
- [ ] Commit: 없음 (브랜치 생성만)
...
- [ ] Commit: `docs(spec-09-12): update README.md for v0.4.0 layout`
...
- [ ] **Archive Commit**: `docs(spec-09-12): archive walkthrough and pr description`
- [ ] **Push**: `git push -u origin spec-09-12-readme-refresh`
- [ ] **PR 생성**
