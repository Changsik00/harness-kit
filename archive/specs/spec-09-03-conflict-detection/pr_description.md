# PR: spec-09-03 — install prefix UX + path config system
...
- `test(spec-09-03): add failing test for path config system`
- `refactor(spec-09-03): fix common.sh agent paths and add config reading`
- `feat(spec-09-03): add prefix UX and harness.config.json to install.sh`
- `refactor(spec-09-03): doctor.sh reflects harness.config.json paths`
