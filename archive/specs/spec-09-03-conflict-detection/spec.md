...
| **Spec ID** | `spec-09-03` |
| **Phase** | `phase-09` |
| **Branch** | `spec-09-03-conflict-detection` |
| **상태** | Planning |
| **타입** | Feature |
...
8. **`common.sh` 경로 수정**: `SDD_AGENT`/`SDD_TEMPLATES`를 `.harness-kit/agent/`로 수정 (spec-09-01에서 누락).
...
- [ ] `spec-09-03-conflict-detection` 브랜치 push 완료
- [ ] 사용자 검토 요청 알림 완료
