...
| **Spec ID** | `spec-11-04` |
| **Phase** | `phase-11` |
| **Branch** | `spec-11-04-archive-search` |
| **상태** | Planning |
| **타입** | Feature |
...
spec-11-03에서 `sdd archive` 명령이 도입되어 완료 항목을 `archive/` 디렉토리로 이동할 수 있게 되었다. 하지만 아카이브 후 `sdd spec list`, `sdd phase list`, `sdd phase show`, `sdd spec show` 등의 명령이 아카이브된 항목을 찾지 못한다.
...
- [ ] `spec-11-04-archive-search` 브랜치 push 완료
- [ ] 사용자 검토 요청 알림 완료
