# Research Report: spec-05-01 — spec-kit 워크플로 벤치마크
...
spec-kit은 여러 AI 에이전트를 지원하지만, harness-kit은 Claude Code 전용으로 깊이를 추구한다. 이 방향은 spec-05-02 (AGENTS.md 호환)에서 별도 검토.
