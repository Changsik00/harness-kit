...
### 1-1. 브랜치 생성
- [x] `git checkout -b spec-10-002-status-cross-check` (base: `phase-10-status-reliability`)
- [x] Commit: 없음 (브랜치 생성만)
...
- [x] Commit: `test(spec-10-002): add failing tests for status self-diagnosis`
...
- [x] Commit: `feat(spec-10-002): add branch pattern work mode inference`
...
- [x] Commit: `feat(spec-10-002): add status cross-check diagnostics`
...
- [x] Commit: `chore(spec-10-002): sync sdd to .harness-kit`
...
- [ ] **Archive Commit**: `docs(spec-10-002): archive walkthrough and pr description`
- [ ] **Push**: `git push -u origin spec-10-002-status-cross-check`
- [ ] **PR 생성**: `/hk-pr-gh`
- [ ] **사용자 알림**: PR URL 보고
