# feat(spec-09-06): add gitignore config option to install.sh and update.sh
...
- `specs/spec-09-06-gitignore-config/`: spec, plan, task, walkthrough, pr_description
...
- Walkthrough: `specs/spec-09-06-gitignore-config/walkthrough.md`
