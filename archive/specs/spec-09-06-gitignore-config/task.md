...
### 1-1. 브랜치 생성
- [x] `git checkout -b spec-09-06-gitignore-config`

### 1-2. 테스트 작성 (TDD Red)
- [x] `tests/test-gitignore-config.sh` 작성 (11 checks)
- [x] 테스트 실행 → FAIL 확인
- [x] Commit: `test(spec-09-06): add failing tests for gitignore config option`
...
- [x] Commit: `feat(spec-09-06): add gitignore config option to install.sh and update.sh`
...
- [ ] **Archive Commit**: `docs(spec-09-06): archive walkthrough and pr description`
- [ ] **Push**: `git push -u origin spec-09-06-gitignore-config`
- [ ] **PR 생성** (사용자 승인 후)
- [ ] **사용자 알림**: PR URL 보고
