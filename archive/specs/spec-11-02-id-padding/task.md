...
### 1-1. 브랜치 생성
- [x] `git checkout -b spec-11-02-id-padding`
...
- [x] Commit: `refactor(spec-11-02): add 2-digit zero padding to phase id generation`
...
- [ ] Commit: `refactor(spec-11-02): migrate all phase/spec ids to 2-digit padding`
...
- [ ] Commit: `docs(spec-11-02): update governance examples to 2-digit padded ids`
...
- [ ] **Push**: `git push -u origin spec-11-02-id-padding`
- [ ] **PR 생성**: `/hk-pr-gh`
