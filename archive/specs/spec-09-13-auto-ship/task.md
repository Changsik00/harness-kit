...
- [ ] `git checkout -b spec-09-13-auto-ship` (from `phase-09-install-conflict-defense`)
- [ ] Commit: 없음 (브랜치 생성만)
...
- [ ] Commit: `feat(spec-09-13): auto-ship delegation in governance docs`
...
- [ ] Commit: `feat(spec-09-13): auto-ship in hk-ship command`
...
- [ ] **Archive Commit**: `docs(spec-09-13): archive walkthrough and pr description`
- [ ] **Push**: `git push -u origin spec-09-13-auto-ship`
- [ ] **PR 생성**
