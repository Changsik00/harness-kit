...
| **Spec ID** | `spec-08-01` |
| **Phase** | `phase-08` |
| **Branch** | `spec-08-01-queue-redesign` |
...
- Phase base branch 생성/관리 로직 (→ spec-08-02)
- hk-ship archive 강제 (→ spec-08-03)
- hk-align 출력 개선 (→ spec-08-04)

## ✅ Definition of Done

- [ ] 모든 단위 테스트 PASS
- [ ] `walkthrough.md` 와 `pr_description.md` 작성 및 archive commit
- [ ] `spec-08-01-queue-redesign` 브랜치 push 완료 (→ phase-08 브랜치 타깃)
- [ ] 사용자 검토 요청 알림 완료
