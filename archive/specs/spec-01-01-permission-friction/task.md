...
### 1-1. 브랜치 생성
- [x] `git checkout -b spec-01-01-permission-friction`
- [x] Commit: 없음 (브랜치 생성만)
...
- [x] Commit: `docs(spec-01-01): add single-command principle to agent.md`
...
- [x] Commit: `feat(spec-01-01): add self-contained fallback to sdd status`
...
- [x] 중복 0건 확인
- [x] Commit: `fix(spec-01-01): remove duplicate permission rules in settings.json`
...
- [x] Commit: `fix(spec-01-01): simplify align command to single sdd status call`
...
- [x] **Archive Commit**: `docs(spec-01-01): archive walkthrough and pr description`
- [x] **Push**: `git push -u origin spec-01-01-permission-friction`
