...
2. `archive/` 레이아웃: 원본 구조 보존 (`archive/specs/spec-01-01-slug/`, `archive/backlog/phase-01.md`)
...
- 아카이브된 항목을 sdd 명령에서 검색하는 기능 (spec-11-04에서 처리)
...
- [ ] `spec-11-03-dir-archive` 브랜치 push 완료
- [ ] 사용자 검토 요청 알림 완료
