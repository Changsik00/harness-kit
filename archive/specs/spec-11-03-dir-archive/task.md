...
### 1-1. 브랜치 생성
- [x] `git checkout -b spec-11-03-dir-archive`
...
- [x] Commit: `feat(spec-11-03): implement sdd archive for directory archival`
...
- [x] Commit: `feat(spec-11-03): add archive suggestion to status diagnostics and align`
...
- [x] Commit: `test(spec-11-03): add directory archive tests`
...
- [ ] **Push**: `git push -u origin spec-11-03-dir-archive`
- [ ] **PR 생성**: `/hk-pr-gh`
