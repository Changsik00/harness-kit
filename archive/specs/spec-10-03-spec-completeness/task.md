...
### 1-1. 브랜치 생성
- [x] `git checkout -b spec-10-03-spec-completeness` (base: `phase-10-status-reliability`)
- [x] Commit: 없음 (브랜치 생성만)
...
- [x] Commit: `test(spec-10-03): add failing tests for spec completeness`
...
- [x] Commit: `feat(spec-10-03): add artifact completeness to status`
...
- [x] Commit: `chore(spec-10-03): sync sdd to .harness-kit`
...
- [ ] **Archive Commit**: `docs(spec-10-03): archive walkthrough and pr description`
- [ ] **Push**: `git push -u origin spec-10-03-spec-completeness`
- [ ] **PR 생성**: `/hk-pr-gh`
- [ ] **사용자 알림**: PR URL 보고
