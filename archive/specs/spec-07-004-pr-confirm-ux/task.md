...
- [x] Spec 디렉토리 생성: `specs/spec-07-004-pr-confirm-ux/`
- [x] spec.md 작성
- [x] plan.md 작성
- [x] task.md 작성 (이 파일)
- [ ] 사용자 Plan Accept
...
### 1-1. 브랜치 생성
- [ ] `git checkout -b spec-07-004-pr-confirm-ux`

### 1-2. hk-gh-pr.md 수정
- [ ] `sources/commands/hk-gh-pr.md` — §4에 PR 확인 블록 + Y/n + `--no-confirm` 추가
- [ ] `.claude/commands/hk-gh-pr.md` — 동일 반영
- [ ] Commit: `refactor(spec-07-004): add pr confirm block to hk-gh-pr`
...
- [ ] Commit: `refactor(spec-07-004): standardize push confirm block in hk-handoff`
...
- [ ] Commit: `refactor(spec-07-004): add pr confirm block to hk-bb-pr`
...
- [ ] Commit: `refactor(spec-07-004): add affirmative/reject rules to hk-spec-critique prompt`
...
- [ ] **Archive Commit**: `docs(spec-07-004): archive walkthrough and pr description`
- [ ] **Push**: `git push -u origin spec-07-004-pr-confirm-ux`
