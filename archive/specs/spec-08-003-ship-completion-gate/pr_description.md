# feat(spec-08-003): add completion gate to sdd archive and spec-x done flow
...
- Spec: `specs/spec-08-003-ship-completion-gate/spec.md`
- Walkthrough: `specs/spec-08-003-ship-completion-gate/walkthrough.md`
