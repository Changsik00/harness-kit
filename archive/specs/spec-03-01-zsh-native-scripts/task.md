...
### 1-1. 브랜치 생성
- [x] `git checkout -b spec-03-01-zsh-native-scripts`
...
- [x] Commit: `feat(spec-03-01): add _script_dir shell compat function to _lib.sh`
...
- [x] Commit: `refactor(spec-03-01): replace BASH_SOURCE with _self in hooks`
...
- [x] Commit: `refactor(spec-03-01): remove bash arrays and BASH_SOURCE from sdd`
...
- [x] Commit: `feat(spec-03-01): add --shell option to install.sh for zsh support`
...
- [x] Commit: `feat(spec-03-01): add zsh detection to doctor.sh`
...
- [x] Commit: `chore(spec-03-01): sync scripts/harness/ with sources/`
...
- [x] Commit: `test(spec-03-01): add zsh compatibility verification test`
...
- [x] **Archive Commit**: `docs(spec-03-01): archive walkthrough and pr description`
- [x] **Push**: `git push -u origin spec-03-01-zsh-native-scripts`
- [x] **PR 생성**: `/gh-pr`
