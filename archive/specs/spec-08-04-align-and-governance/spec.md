# spec-08-04: hk-align 강화 & 거버넌스 통합 & README 최신화
...
| **Spec ID** | `spec-08-04` |
| **Phase** | `phase-08` |
| **Branch** | `spec-08-04-align-and-governance` |
...
- sdd status 출력 포맷 변경 (이미 spec-08-01에서 완료)
...
- [ ] `spec-08-04-align-and-governance` 브랜치 push 완료 (→ `phase-08-work-model`)
- [ ] 사용자 검토 요청 알림 완료
