...
- [x] Spec ID 확정 및 디렉토리 생성 (`specs/spec-08-04-align-and-governance/`)
- [x] spec.md 작성
- [x] plan.md 작성
- [x] task.md 작성 (이 파일)
...
### 1-1. 브랜치 생성
- [ ] `git checkout -b spec-08-04-align-and-governance phase-08-work-model`
- [ ] Commit: 없음 (브랜치 생성만)

### 1-2. hk-align.md 수정
- [ ] `sources/commands/hk-align.md` Step 4 상태 포맷에 NOW/NEXT 행 추가
- [ ] Commit: `feat(spec-08-04): add now/next display to hk-align status report`
...
- [ ] Commit: `docs(spec-08-04): add work type behavior rules and completion checklists to agent.md`
...
- [ ] 워크플로 요약 갱신
- [ ] 기타 오래된 정보 정리
- [ ] Commit: `docs(spec-08-04): update readme with phase-08 changes and work type model`
...
- [ ] **Archive Commit**: `docs(spec-08-04): archive walkthrough and pr description`
- [ ] **Push**: `git push -u origin spec-08-04-align-and-governance`
