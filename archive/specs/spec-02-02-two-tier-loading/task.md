...
### 1-1. 브랜치 생성
- [x] `git checkout -b spec-02-02-two-tier-loading`
- [x] Commit: 없음 (브랜치 생성만)
...
- [x] Commit: `refactor(spec-02-02): remove @imports from CLAUDE.md.fragment`
...
- [x] Commit: `chore(spec-02-02): sync CLAUDE.md harness block with fragment`
...
- [x] 테스트 실행 → 7/7 PASS
- [x] Commit: `test(spec-02-02): add two-tier loading verification test`
...
- [x] **Archive Commit**: `docs(spec-02-02): archive walkthrough and pr description`
- [x] **Push**: `git push -u origin spec-02-02-two-tier-loading`
- [x] **PR 생성**: `/gh-pr`
- [x] **사용자 알림**
