...
### 1-1. 브랜치 생성
- [x] `git checkout -b spec-02-01-governance-dedup`
- [x] Commit: 없음 (브랜치 생성만)
...
- [x] Commit: `fix(spec-02-01): update pr creation rule to reflect slash commands`
...
- [x] Commit: `refactor(spec-02-01): deduplicate and clean up agent.md`
...
- [x] Commit: `chore(spec-02-01): sync agent/ with sources/governance/`
...
- [x] Commit: `test(spec-02-01): add governance dedup verification test`
...
- [x] **Archive Commit**: `docs(spec-02-01): archive walkthrough and pr description`
- [x] **Push**: `git push -u origin spec-02-01-governance-dedup`
