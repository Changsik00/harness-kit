# spec-02-01: 거버넌스 문서 중복 제거 및 실효성 정리
...
| **Spec ID** | `spec-02-01` |
| **Phase** | `phase-02` |
| **Branch** | `spec-02-01-governance-dedup` |
| **상태** | Planning |
| **타입** | Refactor |
...
3. CLAUDE.md의 핵심 규칙 요약은 이 spec에서 변경하지 않음 (spec-02-02 범위).

## 🚫 Out of Scope

- CLAUDE.md 구조 변경 (spec-02-02)
- hook 동작 모드 변경 (spec-02-03)
...
- [ ] `spec-02-01-governance-dedup` 브랜치 push 완료
- [ ] 사용자 검토 요청 알림 완료
