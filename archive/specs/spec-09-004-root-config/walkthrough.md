...
Commit: `8636e43 test(spec-09-004): update test-path-config for rootDir`
...
Commit: `764445c feat(spec-09-004): always write rootDir to harness.config.json`
...
Commit: `1012b80 refactor(spec-09-004): sdd_find_root reads rootDir from config`
