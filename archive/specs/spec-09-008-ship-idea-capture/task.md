...
### 1-1. 브랜치 생성
- [ ] `git checkout -b spec-09-008-ship-idea-capture` (from `phase-09-install-conflict-defense`)
...
- [ ] Commit: `feat(spec-09-008): add idea capture gate and opinion divergence protocol to constitution`
...
- [ ] Commit: `feat(spec-09-008): extend bootstrap protocol with continuity check`
...
- [ ] Commit: `chore(spec-09-008): sync dogfooding copies`
...
- [ ] **Archive Commit**: `docs(spec-09-008): archive walkthrough and pr description`
- [ ] **Push**: `git push -u origin spec-09-008-ship-idea-capture`
- [ ] **PR 생성**: 사용자 승인 후
