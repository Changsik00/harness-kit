...
- [x] Spec 디렉토리 생성: `specs/spec-07-01-scope-classification-rules/`
- [x] spec.md 작성
- [x] plan.md 작성
- [x] task.md 작성 (이 파일)
- [x] 사용자 Plan Accept
...
### 1-1. 브랜치 생성
- [ ] `git checkout -b spec-07-01-scope-classification-rules`
...
- [ ] Commit: `refactor(spec-07-01): add work mode decision checklist to constitution §2`
...
- [ ] Commit: `refactor(spec-07-01): add classification output to alignment phase`
...
- [ ] **Archive Commit**: `docs(spec-07-01): archive walkthrough and pr description`
- [ ] **Push**: `git push -u origin spec-07-01-scope-classification-rules`
