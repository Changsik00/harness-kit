...
- [x] Spec ID 확정 및 디렉토리 생성 (`specs/spec-08-05-phase-ship/`)
- [x] spec.md 작성
- [x] plan.md 작성
- [x] task.md 작성 (이 파일)
...
- [x] Commit: `feat(spec-08-05): add hk-phase-ship slash command`
...
- [x] Commit: `feat(spec-08-05): add phase-ship pr template`
...
- [x] Commit: `docs(spec-08-05): add phase ship governance rules to constitution and agent`
...
- [x] **Archive Commit**: `docs(spec-08-05): archive walkthrough and pr description`
- [x] **Push**: `git push -u origin spec-08-05-phase-ship`
