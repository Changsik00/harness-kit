# refactor(spec-09-01): move all harness-kit artifacts to .harness-kit/ hidden directory
...
- **본 SPEC 의 역할**: Phase 9의 첫 스펙으로, 가장 근본적인 충돌 원인인 디렉토리 네임스페이스 오염을 해결. 이후 spec-09-02(CLAUDE.md @import), spec-09-03(config 시스템), spec-09-04(preflight UX)의 기반 레이아웃을 확정함.
...
- Walkthrough: `specs/spec-09-01-dir-layout/walkthrough.md`
