...
### 1-1. 브랜치 생성
- [x] `git checkout -b spec-09-01-dir-layout` (main에서 시작)
- [x] Commit: 없음 (브랜치 생성만)
...
- [x] Commit: `test(spec-09-01): add failing test for new .harness-kit layout`
...
- [x] Commit: `refactor(spec-09-01): change install target dirs to .harness-kit/`
...
- [x] Commit: `refactor(spec-09-01): update settings fragment hook paths to .harness-kit/`
...
- [x] Commit: `refactor(spec-09-01): update all agent/ and scripts/harness/ path refs to .harness-kit/`
...
- [x] Commit: `feat(spec-09-01): add v0.3→v0.4 layout migration to update.sh`
...
- [x] Commit: `refactor(spec-09-01): update uninstall.sh and doctor.sh paths to .harness-kit/`
...
- [x] Commit: `chore(spec-09-01): migrate harness-kit dogfooding to .harness-kit/ layout, bump v0.4.0`
...
- [ ] **Archive Commit**: `docs(spec-09-01): archive walkthrough and pr description`
- [ ] **Push**: `git push -u origin spec-09-01-dir-layout`
