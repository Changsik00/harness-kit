# spec-09-01: 디렉토리 레이아웃 마이그레이션 — .harness-kit/ 은닉 구조 전환
...
`backlog/`, `specs/`는 이 스펙에서 변경하지 않는다 (spec-09-03 scope).
...
- CLAUDE.md @import 방식 전환 (spec-09-02)
- `backlog/`, `specs/` 경로 충돌 감지 및 config 시스템 (spec-09-03)
- install/update.sh preflight 문의 UX (spec-09-04)
...
- [ ] `spec-09-01-dir-layout` 브랜치 push 완료
- [ ] 사용자 검토 요청 알림 완료
