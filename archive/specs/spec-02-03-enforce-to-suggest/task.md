...
### 1-1. 브랜치 생성
- [x] `git checkout -b spec-02-03-enforce-to-suggest`
...
- [x] Commit: `feat(spec-02-03): add per-hook mode resolution to _lib.sh`
...
- [x] Commit: `feat(spec-02-03): apply per-hook default modes to all hooks`
...
- [x] Commit: `feat(spec-02-03): add sdd hooks subcommand`
...
- [x] diff 검증
- [x] Commit: `chore(spec-02-03): sync scripts/harness/ with sources/`
...
- [x] 테스트 실행 → PASS
- [x] Commit: `test(spec-02-03): add hook mode verification test`
...
- [x] **Archive Commit**: `docs(spec-02-03): archive walkthrough and pr description`
- [x] **Push**: `git push -u origin spec-02-03-enforce-to-suggest`
- [x] **PR 생성**: `/gh-pr`
