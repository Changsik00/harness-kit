# Implementation Plan: spec-04-02

## 📋 Branch Strategy

- 신규 브랜치: `spec-04-02-code-review-cmd`
- 시작 지점: `main`
- PR Target: `main`
...
spec-04-01과 동일한 패턴. 슬래시 커맨드 파일 하나(`sources/commands/code-review.md`)만 추가. Agent tool로 독립 컨텍스트에서 코드 리뷰 수행.
