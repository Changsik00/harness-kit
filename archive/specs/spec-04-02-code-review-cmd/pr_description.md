# feat(spec-04-02): /code-review 슬래시 커맨드 추가

## 📋 Summary

### 배경 및 목적
에이전트가 자기 코드를 자기가 검증하는 확인 편향을 완화하기 위해, 독립 sub-agent가 코드 변경을 리뷰하는 옵셔널 슬래시 커맨드를 추가한다. spec-04-01(`/spec-review`)이 기획 리뷰라면, 이 커맨드는 **코드 수준의 실질적 리뷰**에 집중한다.
...
- Walkthrough: `specs/spec-04-02-code-review-cmd/walkthrough.md`
