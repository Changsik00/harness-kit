...
- [x] plan.md 작성
- [x] task.md 작성 (이 파일)
- [x] 백로그 업데이트 (phase-09.md SPEC 표 spec-09-002 Active 추가)
- [ ] 사용자 Plan Accept
...
### 1-1. 브랜치 생성
- [x] `git checkout -b spec-09-002-claude-md-import` (phase-09-install-conflict-defense에서 시작)
- [x] Commit: 없음 (브랜치 생성만)
...
- [x] Commit: `test(spec-09-002): add failing test for CLAUDE.md @import install`
...
- [x] Commit: `feat(spec-09-002): switch CLAUDE.md install to 3-line @import`
...
- [x] Commit: `feat(spec-09-002): update.sh backs up CLAUDE.md before install; fragment-only update via install.sh`
...
- [x] `tests/test-two-tier-loading.sh` → 7/7 PASS
- [x] Commit: `chore(spec-09-002): migrate this repo CLAUDE.md to @import format`
...
- [ ] **Archive Commit**: `docs(spec-09-002): archive walkthrough and pr description`
- [ ] **Push**: `git push -u origin spec-09-002-claude-md-import`
