...
### 1-1. 브랜치 생성
- [x] `git checkout -b spec-10-005-artifact-timing-fix` (base: `phase-10-status-reliability`)
- [x] Commit: 없음 (브랜치 생성만)
...
- [x] Commit: `fix(spec-10-005): exclude walkthrough and pr_description from spec new`
...
- [x] Commit: `feat(spec-10-005): improve walkthrough template with decision and discussion sections`
...
- [x] 전체 회귀 테스트 PASS
- [x] Commit: `chore(spec-10-005): sync sdd and templates to .harness-kit`
...
- [ ] **Archive Commit**: `docs(spec-10-005): archive walkthrough and pr description`
- [ ] **Push**: `git push -u origin spec-10-005-artifact-timing-fix`
- [ ] **PR 생성**: `/hk-pr-gh`
- [ ] **사용자 알림**: PR URL 보고
