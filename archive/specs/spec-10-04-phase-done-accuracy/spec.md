...
| **Spec ID** | `spec-10-04` |
| **Phase** | `phase-10` |
| **Branch** | `spec-10-04-phase-done-accuracy` |
| **상태** | Planning |
| **타입** | Fix |
...
- phase.md 자동 보정 (제안만, 실제 수정 안 함 — spec-10-02에서 이미 진단으로 커버)
- `--quiet` 플래그
...
- [ ] `spec-10-04-phase-done-accuracy` 브랜치 push 완료
- [ ] 사용자 검토 요청 알림 완료
