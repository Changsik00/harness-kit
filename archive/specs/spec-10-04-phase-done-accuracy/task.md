...
### 1-1. 브랜치 생성
- [x] `git checkout -b spec-10-04-phase-done-accuracy` (base: `phase-10-status-reliability`)
- [x] Commit: 없음 (브랜치 생성만)
...
- [x] Commit: `test(spec-10-04): add failing tests for phase done accuracy`
...
- [x] Commit: `fix(spec-10-04): count Done as incomplete in _check_phase_all_merged`
...
- [x] Commit: `fix(spec-10-04): prioritize Done specs in compute_next_spec`
...
- [x] Commit: `chore(spec-10-04): sync sdd to .harness-kit`
...
- [ ] **Archive Commit**: `docs(spec-10-04): archive walkthrough and pr description`
- [ ] **Push**: `git push -u origin spec-10-04-phase-done-accuracy`
- [ ] **PR 생성**: `/hk-pr-gh`
- [ ] **사용자 알림**: PR URL 보고
