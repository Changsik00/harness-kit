# fix(spec-09-10): 슬래시 커맨드 경로 일괄 수정

## 📋 Summary

### 배경 및 목적

spec-09-01에서 디렉토리 레이아웃을 `.harness-kit/`으로 변경했으나, 슬래시 커맨드 내부의 `scripts/harness/bin/sdd` 경로가 갱신되지 않아 커맨드 실행 시 에러 발생.
