# refactor(spec-11-001): sdd archive → sdd ship 리네이밍
...
- **본 SPEC의 역할**: 네이밍 충돌을 선제 해소하여 spec-11-003(디렉토리 아카이브)에서 `archive` 이름을 자유롭게 사용 가능하게 함
...
- Walkthrough: `specs/spec-11-001-ship-rename/walkthrough.md`
