...
| **Spec ID** | `spec-08-02` |
| **Phase** | `phase-08` |
| **Branch** | `spec-08-02-phase-base-branch` |
...
- spec 간 의존성 처리 불가 — spec-08-01 결과물 위에서 spec-08-02를 작업하려면 main merge를 기다려야 함
...
- hk-ship의 `sdd archive` 강제 및 phase done 유도 (→ spec-08-03)
- hk-align NOW/NEXT/Icebox 출력 개선 (→ spec-08-04)
...
- [ ] `spec-08-02-phase-base-branch` 브랜치 push 완료 (→ `phase-08-work-model`)
- [ ] 사용자 검토 요청 알림 완료
